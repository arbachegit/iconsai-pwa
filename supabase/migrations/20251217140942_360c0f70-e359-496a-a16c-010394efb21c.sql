-- Função otimizada usando INSERT...SELECT com JOINs (executa em segundos ao invés de timeout)
...
AS $$
BEGIN
  -- Deletar registros antigos para reprocessar
  DELETE FROM pmc_valores_reais;

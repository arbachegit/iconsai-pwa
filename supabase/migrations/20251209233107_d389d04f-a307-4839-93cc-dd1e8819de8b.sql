-- Create system_versions table for automated semantic versioning
...
CREATE TRIGGER auto_version_increment
AFTER INSERT ON public.user_activity_logs
FOR EACH ROW
WHEN (NEW.action_category IN ('UPLOAD', 'DELETE', 'CONFIG'))
